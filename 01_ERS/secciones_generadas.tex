...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img001.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img003.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img004.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img005.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img006.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img007.png}
...
Se presentan 15 Requisitos No Funcionales (RNF-01 a RNF-15), cubriendo las nueve características de calidad de ISO/IEC 25010:2023. Los seis primeros provienen de la Entrega 1B; RNF-07 a RNF-15 son borradores iniciales redactados para esta entrega y deben confirmarse o ajustarse con los datos que arrojen las entrevistas de la Sección 3 (RNF) del guion general --- no se presentan como resultado final validado.
...
\begin{longtable}{|p{3.9cm}|p{3.9cm}|p{3.9cm}|p{3.9cm}|}
\hline
ID & Descripción cuantificada & Característica ISO 25010 & Criterio de verificación \\ \hline
NFR-01 & El sistema debe entregar alertas de anomalía en $\leq$60 s desde la detección. & Eficiencia de desempeño & Prueba de carga con 50 aulas simuladas; medición del tiempo real de entrega. \\ \hline
NFR-02 & Disponibilidad $\geq$99 \% mensual (downtime $\leq$7,3 h/mes). & Fiabilidad & Monitoreo de uptime durante 30 días continuos. \\ \hline
NFR-03 & Datos en tránsito y reposo cifrados con AES-256; acceso sin credenciales rechazado en el 100 \% de los casos. & Seguridad & Auditoría de cifrado + intento de acceso sin credenciales rechazado en todos los casos. \\ \hline
NFR-04 & Usuario sin capacitación previa completa 'consultar estado de un aula' en $\leq$2 min. & Interacción de usuario & Prueba de usabilidad con $\geq$3 usuarios reales, medición del tiempo de tarea. \\ \hline
NFR-05 & La interfaz debe funcionar sin instalación adicional en Chrome, Firefox y Edge, en resoluciones de 360px a 1920px. & Portabilidad / Compatibilidad & Prueba cruzada en 3 navegadores y 2 tamaños de pantalla. \\ \hline
NFR-06 & Cobertura de pruebas unitarias $\geq$70 \% en módulos críticos (alertas y control remoto). & Mantenibilidad & Reporte de cobertura generado por la herramienta de testing del proyecto. \\ \hline
NFR-07 & Adecuación funcional: el módulo de detección de ocupación debe mantener una tasa de acierto $\geq$95 \% frente al estado real observado, medida sobre una muestra de auditoría mensual. & Adecuación funcional & Auditoría manual mensual de una muestra de aulas comparando estado del sistema vs. observación directa. \\ \hline
NFR-08 & Compatibilidad: la integración con el Sistema de Horario Académico debe completarse sin pérdida de datos en el 100 \% de las sincronizaciones, verificado mediante checksum de los registros importados. & Compatibilidad & Prueba de sincronización con conjunto de datos de horario de prueba; verificación de integridad por checksum. \\ \hline
NFR-09 & Flexibilidad: incorporar un nuevo tipo de sensor IoT al sistema no debe requerir más de 8 horas-persona de esfuerzo de desarrollo, sin modificar el núcleo de la plataforma. & Flexibilidad & Ejercicio de integración de un sensor ficticio adicional, medición del esfuerzo real invertido. \\ \hline
NFR-10 & Explicabilidad: el módulo de análisis predictivo (RF-09) debe presentar la explicación de cada predicción de falla en $\leq$2 s, con $\leq$60 palabras, y el usuario técnico debe reportar comprenderla con calificación media $\geq$4/5 en escala Likert de 1 a 5. & Interacción de usuario (explicabilidad, taxonomía de Chazette y Schneider, 2020) & Prueba con $\geq$6 participantes (3 técnicos, 3 no técnicos) en dos rondas de validación; medición de tiempo de respuesta y encuesta de comprensión. \\ \hline
NFR-11 & Derecho de acceso (Art. 13 LOPDP): el sistema debe permitir exportar los datos personales de un usuario en $\leq$15 días hábiles desde la solicitud (soporta RF-24). & Seguridad / Cumplimiento legal & Solicitud de prueba registrada y medición del tiempo hasta la disponibilidad del archivo exportado. \\ \hline
NFR-12 & El sistema debe generar una alerta automática al administrador ante un intento de acceso no autorizado detectado, en $\leq$5 minutos desde el evento. & Seguridad & Simulación de intento de acceso no autorizado; medición del tiempo hasta la alerta generada. \\ \hline
NFR-13 & Fiabilidad: ante una caída del Gateway IoT de un aula, el sistema debe reanudar la recepción de datos en $\leq$5 minutos tras el restablecimiento de la conexión, sin pérdida de lecturas posteriores al reinicio. & Fiabilidad & Prueba de corte y restablecimiento de conexión controlado sobre un gateway de prueba. \\ \hline
NFR-14 & Mantenibilidad: el tiempo medio de diagnóstico de una falla reportada por el sistema (desde la alerta hasta la identificación de la causa) no debe superar los 15 minutos para el personal de TI. & Mantenibilidad & Registro de tiempos de diagnóstico durante el periodo de prueba del MVP. \\ \hline
NFR-15 & Portabilidad: la interfaz web debe ser completamente operativa (sin pérdida de funciones críticas) en conexiones con ancho de banda reducido, de al menos 1 Mbps. & Portabilidad & Prueba de acceso a la plataforma bajo throttling de red simulado a 1 Mbps. \\ \hline
\caption{Requisitos no funcionales cuantificados (ISO/IEC 25010:2023)}
\end{longtable}
\endgroup
...
Notificación de vulneraciones de seguridad & Deber de notificar ante brechas de seguridad detectadas. & RNF-12 & Alerta automática al administrador ante acceso no autorizado. \\ \hline
Deber de demostrar cumplimiento & El responsable debe poder demostrar las medidas administrativas y técnicas aplicadas. & RF-23 & Bitácora de acciones de usuario como mecanismo de auditoría ante la Autoridad de Protección de Datos. \\ \hline
Imagen como dato personal (cámaras) & La imagen que identifica a una persona es dato personal. & RD-05, RF-03, RF-06 & SIGA procesa el video de la cámara únicamente para determinar presencia/ocupación de forma agregada (verdadero/falso), cruzado con el Horario Académico como referencia pero con prioridad del estado real detectado; no almacena el video ni los fotogramas, y no realiza reconocimiento facial ni identificación de personas. \\ \hline
...
RD-15 & Temporal & Para la Entrega 4 (2B) se completará el manuscrito de publicación, el dataset FAIR en Zenodo y el cierre de la evidencia de campo hasta 24 participantes. & La entrega actual (2A) produce los datos empíricos que la Entrega 4 analizará y reportará en el manuscrito paralelo. & RF-01 a RF-25, RNF-01 a RNF-15 \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img008.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img009.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img010.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img011.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img012.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img013.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img014.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img015.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img016.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figuras/img017.png}
...
Nuevo en esta entrega. La clasificación Kano de cada RF requiere el par de preguntas funcional/disfuncional aplicado en el cuestionario de estudiantes (Sección C del instrumento ``cuestionario\_estudiantes\_v2.0'') y en las entrevistas de Coordinadores/Conserjes. La tabla siguiente deja preparada la estructura con los RF candidatos; la columna ``Clasificación Kano'' se completa una vez procesadas las respuestas --- no se reporta un resultado aquí para evitar declarar una clasificación sin el sustento estadístico correspondiente (regla anti-fabricación de la guía, gatekeeper G4).
...
RF-08 & Generación y envío de alertas & En proceso de recolección (cuestionario) & Cuestionario estudiantes P11/P12, entrevista general \\ \hline
RF-07 & Panel de control centralizado & En proceso de recolección (cuestionario) & Cuestionario estudiantes P7/P8 \\ \hline
RF-05 & Ajuste remoto de climatización & En proceso de recolección (cuestionario) & Cuestionario estudiantes P17/P18 \\ \hline
RF-12 & Gestión de solicitudes de mantenimiento & En proceso de recolección (cuestionario) & Entrevista Coordinadores/Conserjes, Sección 5 \\ \hline
RF-09 & Análisis predictivo de fallos (IA) & En proceso de recolección (cuestionario) & Cuestionario estudiantes P8/P9 (explicabilidad) \\ \hline
\caption{Estructura de clasificación Kano}
\end{longtable}
\endgroup
...
EV-01, EV-02, EV-03 & Infraestructura (14/05) + Docente (30/06) + Estudiantes (01/07) & RF-04 & Monitoreo y control remoto de proyectores & CU-01, CU-02 \\ \hline
...
EV-01, EV-02, EV-03 & Infraestructura (14/05) + Docente (30/06) + Estudiantes (01/07) & RF-07 & Panel de control centralizado & CU-01 \\ \hline
EV-01, EV-03 & Infraestructura (14/05) + Estudiantes (01/07) & RF-08 & Generación y envío de alertas por anomalías & CU-04, CU-05 \\ \hline
EV-02 & Docente de la Facultad 30/06/2026 & RF-09 & Análisis predictivo de fallos mediante IA & CU-16 \\ \hline
EV-01 & Personal de Infraestructura 14/05/2026 & RF-10 & Registro histórico de fallas y mantenimientos & CU-08 \\ \hline
EV-02, EV-03 & Docente (30/06) + Estudiantes (01/07) & RF-11 & Notificación inmediata ante fallas críticas & CU-04, CU-05 \\ \hline
EV-01, EV-02, EV-03 & Infraestructura (14/05) + Docente (30/06) + Estudiantes (01/07) & RF-12 & Gestión de solicitudes de mantenimiento & CU-06, CU-07 \\ \hline
EV-01 & Personal de Infraestructura 14/05/2026 & RF-13 & Control automático de apagado energético & CU-13 \\ \hline
EV-02 & Docente de la Facultad 30/06/2026 & RF-14 & Análisis de patrones de consumo energético & CU-16 \\ \hline
...
EV-02 & Docente de la Facultad 30/06/2026 & RF-17 & Generación de reportes estadísticos periódicos & CU-09 \\ \hline
EV-02 & Docente de la Facultad 30/06/2026 & RF-18 & Exportación de reportes PDF/Excel & CU-10 \\ \hline
EV-02 & Docente de la Facultad 30/06/2026 & RF-19 & Gestión de acceso diferenciado por roles & CU-11 \\ \hline
EV-02 & Docente de la Facultad 30/06/2026 & RF-20 & Registro del historial de ocupación & CU-01, CU-08 \\ \hline
...
EV-01, EV-02 & Infraestructura (14/05) + Docente (30/06) & RF-23 & Registro de bitácora de acciones de usuario & CU-14 \\ \hline
...
Enfoque 1: comparación de la calidad de los Requisitos Funcionales elicitados por el equipo humano frente a los generados por un Modelo Grande de Lenguaje (LLM) a partir del mismo material fuente (transcripciones EV-01 y EV-02).
...
Población & Requisitos funcionales del dominio SIGA (gestión inteligente de aulas). \\ \hline
Intervención & Generación de RF mediante un LLM (GPT-4o o Claude) a partir de la transcripción anonimizada de EV-01/EV-02. \\ \hline
Comparación & RF elicitados por el equipo humano (Sección 3.2) a partir del mismo material fuente. \\ \hline
Resultado & Diferencias en completitud, no ambigüedad, verificabilidad, corrección y consistencia. \\ \hline
...
Los principales logros de esta entrega son: la ampliación de 23 a 25 requisitos funcionales con plantilla de 8 atributos; la especificación de 15 requisitos no funcionales cuantificados sobre las nueve características de ISO/IEC 25010:2023, incluido el requisito de explicabilidad obligatorio para RF-09; la incorporación de una sección de requisitos legales mapeados a la Ley Orgánica de Protección de Datos Personales del Ecuador; la redacción de historias de usuario en formato Connextra con criterios Gherkin para los RF Must; el modelado UML completo con ocho tipos de diagrama y el modelado organizacional i*; la priorización combinada MoSCoW, Kano y WSJF; la ampliación de la matriz de trazabilidad; y la definición del alcance del Producto Mínimo Viable y del protocolo del componente empírico.


Como trabajo pendiente hacia el cierre de esta entrega se identifica: completar la recolección de campo (entrevistas y cuestionario ampliados) para validar con evidencia primaria los RNF-07 a RNF-15 y los RF-24 y RF-25 declarados como borrador; elaborar las figuras de los ocho diagramas UML y del modelado i* a partir de las especificaciones textuales de la Sección IV; completar la clasificación Kano y el puntaje WSJF con datos reales; implementar y desplegar el MVP; y registrar el protocolo experimental en OSF antes de iniciar la recolección de datos del componente empírico.
...
13 & RF-24/RF-25, RNF-07 a RNF-15, requisitos legales, historias de usuario, ERS unificado en LaTeX. & Entrega 3 (2A) & En proceso \\ \hline
...
EV-02 & Entrevista + Video & 30/06/2026 & Docente de la Facultad (FCC-UTEQ) & RF-04, 07, 09, 11, 12, 14, 17, 20, 23 & S \\ \hline
...
Las nuevas evidencias de campo (EV-08 en adelante), correspondientes a las entrevistas con Coordinadores, Conserjes, Docentes adicionales y Personal Administrativo, se incorporan a este catálogo conforme se completa su codificación temática.
...
El repositorio sigue la jerarquía de carpetas establecida para la Entrega 3 (2A): 01\_ERS/ a 08\_Borradores/, con los archivos raíz obligatorios (README.md, LICENSE, CITATION.cff, CHANGELOG.md, .gitignore, checksums.sha256) y Git LFS configurado para la evidencia multimedia.
